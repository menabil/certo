...
// const Blog = () => {
//   return (
//     <section className="bg-linear-to-b from-[#F3F8FF] to-[#E7EFFA] py-10 sm:py-16 md:py-20 lg:py-[84px]">
//       <Container>
//         {/* Main Heading */}
...
const Blog = () => {
  return (
    // Section layer width gap added using px-4 sm:px-6
    <section className="bg-gradient-to-b from-[#F3F8FF] to-[#E7EFFA] py-10 sm:py-16 md:py-20 lg:py-[84px] px-4 sm:px-6 md:px-0">
      <Container>
        {/* Main Heading */}
        <h3 className="text-center text-[#02033B] text-2xl sm:text-3xl md:text-4xl font-extrabold max-w-[650px] leading-snug md:leading-[45px] pb-8 sm:pb-12 md:pb-[72px] mx-auto">
          Get your freedom back, stop mobile spyware today
        </h3>
