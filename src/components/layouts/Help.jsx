  ...
  return (
    <section>
      <Container className={"py-[84px] px-9"}>
        <Flex className={"justify-center flex-col md:flex-row gap-y-10"}>
          <div className="rounded-[48px] bg-linear-to-b from-[#F7C95F] to-[#FDB235] md:p-12 p-7">
            <h5 className="font-extrabold text-[#02033B] text-2xl">
              Read our story
            </h5>
            <p className="text-[16px] text-[#02033B] md:w-[360px] w-[240px] pt-6 pb-12">
